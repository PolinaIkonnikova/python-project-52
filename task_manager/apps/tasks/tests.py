...
class TasksTestCase(TestCase):
    ...
    def test_create_task(self):
        ...
        self.assertContains(post_response, text=messages.task_create)
    ...
    def test_update_task(self):
        ...
        self.assertContains(post_response, text=messages.task_update)
    ...
    def test_delete_self_task(self):
        ...
        self.assertContains(post_response, text=messages.task_delete)
